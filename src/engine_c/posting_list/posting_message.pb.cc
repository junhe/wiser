...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_doc_info_default_instance_);_Posting_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
...
::google::protobuf::int32 Posting::positions(int index) const {
  // @@protoc_insertion_point(field_get:posting_message.Posting.positions)
  return positions_.Get(index);
}
void Posting::set_positions(int index, ::google::protobuf::int32 value) {
  positions_.Set(index, value);
  // @@protoc_insertion_point(field_set:posting_message.Posting.positions)
}
void Posting::add_positions(::google::protobuf::int32 value) {
  positions_.Add(value);
