...
QQEngine::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_Search_(QQEngine_method_names[2], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status QQEngine::Stub::Search(::grpc::ClientContext* context, const ::qq::SearchRequest& request, ::qq::SearchReply* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_Search_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::qq::SearchReply>* QQEngine::Stub::AsyncSearchRaw(::grpc::ClientContext* context, const ::qq::SearchRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::ClientAsyncResponseReader< ::qq::SearchReply>::Create(channel_.get(), cq, rpcmethod_Search_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::qq::SearchReply>* QQEngine::Stub::PrepareAsyncSearchRaw(::grpc::ClientContext* context, const ::qq::SearchRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::ClientAsyncResponseReader< ::qq::SearchReply>::Create(channel_.get(), cq, rpcmethod_Search_, context, request, false);
}
...
QQEngine::Service::Service() {
  ...
  AddMethod(new ::grpc::RpcServiceMethod(
      QQEngine_method_names[2],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< QQEngine::Service, ::qq::SearchRequest, ::qq::SearchReply>(
          std::mem_fn(&QQEngine::Service::Search), this)));
}
...
::grpc::Status QQEngine::Service::Search(::grpc::ServerContext* context, const ::qq::SearchRequest* request, ::qq::SearchReply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
