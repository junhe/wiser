...
TEST_CASE( "QueryProcessor2 works", "[engine]" ) {
  ...
  SECTION("Find top 5") {
    ...
    QueryProcessor2 processor(&iterators, store, 100, 5, false);
    std::vector<ResultDocEntry> result = processor.Process();
    REQUIRE(result.size() == 5);
  ...
  SECTION("Do phrase query of 'hello world'") {
    ...
    QueryProcessor2 processor(&iterators, store, 100, 5, true);
    std::vector<ResultDocEntry> result = processor.Process();
    REQUIRE(result.size() == 5);
  ...
  SECTION("Find top 2") {
    ...
    QueryProcessor2 processor(&iterators, store, 100, 2, false);
    std::vector<ResultDocEntry> result = processor.Process();
    REQUIRE(result.size() == 2);
...
TEST_CASE( "SingleTermQueryProcessor2 works", "[engine]" ) {
  ...
  SECTION("Find top 5") {
    ...
    SingleTermQueryProcessor2 processor(&iterators, store, 100, 5);
    std::vector<ResultDocEntry> result = processor.Process();
    REQUIRE(result.size() == 5);
  ...
  SECTION("Find top 2") {
    ...
    SingleTermQueryProcessor2 processor(&iterators, store, 100, 2);
    std::vector<ResultDocEntry> result = processor.Process();
    REQUIRE(result.size() == 2);
...
TEST_CASE( "TwoTermNonPhraseQueryProcessor2 works", "[engine]" ) {
  ...
  SECTION("Find top 5") {
    ...
    TwoTermNonPhraseQueryProcessor2 processor(&iterators, store, 100, 5);
    std::vector<ResultDocEntry> result = processor.Process();
    REQUIRE(result.size() == 5);
  ...
  SECTION("Find top 2") {
    ...
    TwoTermNonPhraseQueryProcessor2 processor(&iterators, store, 100, 2);
    std::vector<ResultDocEntry> result = processor.Process();
    REQUIRE(result.size() == 2);
